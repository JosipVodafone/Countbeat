...
`${GOPATH}/src/github.com/JosipVodafone/countbeat`
...
```
git remote set-url origin https://github.com/JosipVodafone/countbeat
...
```
mkdir -p ${GOPATH}/src/github.com/JosipVodafone/countbeat
git clone https://github.com/JosipVodafone/countbeat ${GOPATH}/src/github.com/JosipVodafone/countbeat
```
